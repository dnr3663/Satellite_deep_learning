...
tf.app.flags.DEFINE_string("output_graph",
                           "E:/PAPER_RS_DEEPLEARNING/image/NWPU_RESICS45dataset/output_retrain2_graph.pb",
                           "학습된 신경망이 저장된 위치")
tf.app.flags.DEFINE_string("output_labels",
                           "E:/PAPER_RS_DEEPLEARNING/image/NWPU_RESICS45dataset/output_retrain2_labels.txt",
                           "학습할 레이블 데이터 파일")
