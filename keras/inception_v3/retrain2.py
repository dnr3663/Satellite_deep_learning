...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='E:/PAPER_RS_DEEPLEARNING/image/NWPU_RESICS45dataset/output_retrain2_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='E:/PAPER_RS_DEEPLEARNING/image/NWPU_RESICS45dataset/output_retrain2_labels.txt',
